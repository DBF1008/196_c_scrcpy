...
public class ControlMessageReaderTest {
    ...
    @Test
    public void testParseStartAppWithForceStopPrefix() throws IOException {
        byte[] name = "+com.example.app".getBytes(StandardCharsets.UTF_8);
        ...
        ControlMessage event = reader.read();
        Assert.assertEquals(ControlMessage.TYPE_START_APP, event.getType());
        Assert.assertEquals("+com.example.app", event.getText());

        Assert.assertEquals(-1, bis.read()); // EOS
    }

    @Test
    public void testParseStartAppWithNameSearchPrefix() throws IOException {
        byte[] name = "?firefox".getBytes(StandardCharsets.UTF_8);
    ...
    @Test
    public void testParseStartAppWithDryRunPrefix() throws IOException {
        byte[] name = "~?firefox@2".getBytes(StandardCharsets.UTF_8);
        ...
        ControlMessage event = reader.read();
        Assert.assertEquals(ControlMessage.TYPE_START_APP, event.getType());
        Assert.assertEquals("~?firefox@2", event.getText());

        Assert.assertEquals(-1, bis.read()); // EOS
    }

    @Test
    public void testParseStartAppWithCombinedPrefixes() throws IOException {
        byte[] name = "+~?fire@0".getBytes(StandardCharsets.UTF_8);
        ...
        ControlMessage event = reader.read();
        Assert.assertEquals(ControlMessage.TYPE_START_APP, event.getType());
        Assert.assertEquals("+~?fire@0", event.getText());
